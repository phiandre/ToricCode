...
class RLsys:
	...
	"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
	def __init__(self, actions, state_size, miniBatchSize = 32, TNRate = 100 , memorySize = 1000000, reward_decay=0.9, e_greedy=0.9, numLayers = 0):
		...
		self.qnet = QNet(self.state_size,numLayers)
		self.targetNet = QNet(self.state_size,numLayers)
